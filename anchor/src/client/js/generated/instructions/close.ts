...
export type CloseInput<
  ...
  TAccountSupplyChain extends string = string,
> = {
...
>(
  input: CloseInput<TAccountPayer, TAccountSupplyChain>,
  config?: { programAddress?: TProgramAddress }
): CloseInstruction<TProgramAddress, TAccountPayer, TAccountSupplyChain> {
  // Program address.
  ...
  const instruction = {
    accounts: [
      ...
      getAccountMeta(accounts.supply_chain),
    ],
    programAddress,
    data: getCloseInstructionDataEncoder().encode({}),
  } as CloseInstruction<TProgramAddress, TAccountPayer, TAccountSupplyChain>;
